...
RECOVERY_WELCOME := 欢迎使用
RECOVERY_VERSION_2 := CWM中文恢复系统 6.0.3.7
RECOVERY_ABOUT := 编译作者：@pexcn
RECOVERY_WEIBO := 支持微博：weibo.com/pexcn
RECOVERY_BUILD_DATE := 编译日期：$(shell date +%F)

LOCAL_CFLAGS += -DRECOVERY_VERSION="$(RECOVERY_VERSION)"
LOCAL_CFLAGS += -DRECOVERY_WELCOME="$(RECOVERY_WELCOME)"
LOCAL_CFLAGS += -DRECOVERY_VERSION_2="$(RECOVERY_VERSION_2)"
LOCAL_CFLAGS += -DRECOVERY_ABOUT="$(RECOVERY_ABOUT)"
LOCAL_CFLAGS += -DRECOVERY_WEIBO="$(RECOVERY_WEIBO)"
